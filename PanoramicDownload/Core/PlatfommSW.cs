            ...
            try
            {
                ...
                for (int x = 1; x <= imageIndex; x++)
                {
                    ...
                    if (urlKeysList[2].Length.Equals(3))
                    {
                        if (x < 10)
                        {
                            image3 = Image.FromStream(ByteToStream(SetImageToByteArray(imagePath + "l" + imageQuality + "_" + tpye + "_0" + 1 + "_0" + x + ".jpg")));
                            if (image3 != null)
                            {
                                image3 = Image.FromStream(ByteToStream(SetImageToByteArray(imagePath + "l" + imageQuality + "_" + tpye + "_0" + 1 + "_0" + x + ".jpg")));
                            }
                        ...
                        {
                            image3 = Image.FromStream(ByteToStream(SetImageToByteArray(imagePath + "l" + imageQuality + "_" + tpye + "_0" + 1 + "_" + x + ".jpg")));
                            if (image3 != null)
                            {
                                image3 = Image.FromStream(ByteToStream(SetImageToByteArray(imagePath + "l" + imageQuality + "_" + tpye + "_0" + 1 + "_" + x + ".jpg")));
                            }
                    ...
                    {
                        image3 = Image.FromStream(ByteToStream(SetImageToByteArray(imagePath + "l" + imageQuality + "_" + tpye + "_" + 1 + "_" + x + ".jpg")));
                        if (image3 != null)
                        {
                            image3 = Image.FromStream(ByteToStream(SetImageToByteArray(imagePath + "l" + imageQuality + "_" + tpye + "_" + 1 + "_" + x + ".jpg")));
                        }
