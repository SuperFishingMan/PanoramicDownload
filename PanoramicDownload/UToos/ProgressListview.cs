    ...
    public partial class ProgressListview : ListView
    {
        ...
        protected override void OnDrawSubItem(DrawListViewSubItemEventArgs e)
        {
            if (e.ColumnIndex == ProgressColumnIndex)
            {
                ...
                g.DrawRectangle(new Pen(new SolidBrush(Color.Black), 1), progressRect);
                ...
                if(float.TryParse(item.Text, out value))
                {
                    ...
                    g.FillRectangle(new SolidBrush(Color.Tomato), new RectangleF(progressRect.X + 1, progressRect.Y + 1, float.Parse(percent.ToString()), progressRect.Height - 1));
